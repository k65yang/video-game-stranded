...
private:
	...
	const std::unordered_map<AUDIO, std::string> chunk_paths {
		...
		{PLAYER_LOW_HUNGER, audio_path("player_low_hunger.wav")},
	...
	std::unordered_map<AUDIO, int> volumes {
		...
		{MOB_HIT, MIX_MAX_VOLUME * .85f},
		{PLAYER_HIT, MIX_MAX_VOLUME * 0.75f},
		{PLAYER_LOW_HEALTH, MIX_MAX_VOLUME * 0.75f},
		{PLAYER_LOW_HUNGER, MIX_MAX_VOLUME * 0.4f},
		{PLAYER_DEATH, MIX_MAX_VOLUME * 1.0f},
		{SHOT, MIX_MAX_VOLUME * 0.72f},
		{SHOT_MG, MIX_MAX_VOLUME * 0.55f},
		{SHOT_CROSSBOW, MIX_MAX_VOLUME * .7f},
