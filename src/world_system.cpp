...
void WorldSystem::restart_game() {
	...
	player_equipped_weapon = createWeaponComponent(ITEM_TYPE::WEAPON_NONE);
		...
		if (registry.players.has(entity)) {
			...
			if (registry.items.has(entity_other)) {
				...
				case ITEM_TYPE::WEAPON_GENERIC:
					player_equipped_weapon = createWeaponComponent(ITEM_TYPE::WEAPON_GENERIC);
...
Entity WorldSystem::createWeaponComponent(ITEM_TYPE weapon_type) {
	// Reserve an entity
	auto entity = Entity();
